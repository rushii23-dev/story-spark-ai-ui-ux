...
const Guidelines = () => {
  return (
    <main className="min-h-screen bg-gradient-to-b from-[#070B18] via-[#081022] to-black text-white">
      <section className="relative overflow-hidden px-6 pb-12 pt-24 sm:pb-16 sm:pt-28 lg:pt-32">
        <div className="absolute left-1/2 top-0 -z-10 h-[420px] w-[760px] -translate-x-1/2 rounded-full bg-blue-600/10 blur-[110px]" />
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-3">
            {[
              ...
              <div
                key={item}
                className="rounded-2xl border border-white/10 bg-white/[0.04] px-5 py-4 text-sm font-medium text-slate-200"
              >
                {item}
              </div>
            ))}
      ...
      <section className="mx-auto grid max-w-6xl gap-5 px-6 pb-14 lg:grid-cols-[0.8fr_1.2fr] lg:items-stretch">
        <div className="rounded-2xl border border-blue-500/20 bg-blue-500/10 p-6 sm:p-7">
          ...
          <h2 className="mt-5 text-2xl font-bold text-white">Contributor promise</h2>
        ...
        <div className="rounded-2xl border border-white/10 bg-slate-900/50 p-6 sm:p-7">
          <h2 className="text-2xl font-bold text-white">Before you contribute</h2>
          <div className="mt-5 grid gap-3 sm:grid-cols-2">
            {workflowSteps.map((step, index) => (
              <div key={step} className="flex gap-3 rounded-xl bg-white/[0.03] p-4">
                <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-blue-500/15 text-sm font-bold text-blue-300">
                  {index + 1}
                </span>
      ...
      <section className="mx-auto max-w-6xl px-6 pb-16">
        <div className="mb-7 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <h2 className="mt-2 text-3xl font-bold text-white">How we work together</h2>
          </div>
        ...
        <div className="grid gap-5 md:grid-cols-2">
          {guidelineSections.map(({ title, description, icon: Icon, points }) => (
            <article
              key={title}
              className="group rounded-2xl border border-white/10 bg-slate-900/50 p-6 transition-all duration-300 hover:border-blue-500/30 hover:bg-slate-900/80"
            >
      ...
      <section className="mx-auto max-w-6xl px-6 pb-20">
        <div className="rounded-2xl border border-white/10 bg-gradient-to-br from-blue-900/30 via-slate-900 to-black p-6 sm:p-8">
          <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            <div className="max-w-2xl">
              <h2 className="text-2xl font-bold text-white">Need help choosing the right next step?</h2>
              <p className="mt-3 text-sm leading-7 text-slate-300">
            ...
            <div className="flex flex-col gap-3 sm:flex-row">
              <a
                ...
                className="inline-flex items-center justify-center rounded-full border border-white/15 px-5 py-3 text-sm font-semibold text-white transition hover:border-blue-400/40 hover:bg-white/5"
              >
                View Issues
              </a>
              <Link
